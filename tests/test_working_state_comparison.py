...
async def test_read_unit_is_one_connection_one_transaction(factory, engine) -> None:
    ...
    shot, refs, differs, _resolved, _eff, _ready, _vis, _sp = await shots.read_shot_detail(proxy_engine, sid)
...
async def test_read_snapshot_interleave_single_snapshot(factory, engine, monkeypatch) -> None:
    ...
    _shot, _refs, differs, _resolved, _eff, _ready, _vis, _sp = await shots.read_shot_detail(engine, sid)
    ...
    _shot2, _refs2, differs2, _resolved2, _eff2, _ready2, _vis2, _sp2 = await shots.read_shot_detail(engine, sid)
