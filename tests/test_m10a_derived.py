...
def _runtime(): return {"schema_version":1,"materializer":{"algorithm_id":"soloring.boxdepth.rasterizer","algorithm_version":"1.0.0","implementation_sha256":"b"*64},"runtime":{"python":"3.12.0","numpy":"2.0.0","platform_contract":"test-cpu"},"external_components":[]}
